(function (mdSmart) {
    ...
    $(document).on('pageshow', 'div[id="FA_P01"]', function (event) {
        ...
        $("#FA_P01_DIV_INFO").bind('tap', {}, mdSmart.FA_P01.gotoControlPanelPage);
		$("#FA_P01_DIV_OFF").bind('tap', {}, mdSmart.FA_P01.gotoControlPanelPage);
		$("#FA_P01_BTN_WIND_MINUS").bind('tap', {option:-1}, mdSmart.FA_P01.cmdControlGear);
		$("#FA_P01_BTN_WIND_PLUS").bind('tap', {option:1}, mdSmart.FA_P01.cmdControlGear);
		$("#FA_P01_BTN_POWER_A").bind('tap', {}, mdSmart.FA_P01.cmdControlPowerOff);
		$("#FA_P01_BTN_POWER").bind('tap', {}, mdSmart.FA_P01.cmdControlPowerOff);
    });
	...
	mdSmart.FA_P01.showStatus = function(dataRequest,dataBack){
		...
		if(mdSmart.FA_P01.gear >= 0x01 && mdSmart.FA_P01.gear <= 0x1A){
			$("#FA_P01_LBL_GEAR").html(mdSmart.FA_P01.gear);
		}
