...
(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        function generateWheelItems(i) {
			...
			if(i==1&&loop)
			{
				html += '<div id="dw-v-1" class="dw-li dw-v" data-val="' + 62 + '" style="height:' + hi + 'px;line-height:' + hi + 'px;"><div class="dw-i">' + warr[i][58] + '</div></div>';
				html += '<div id="dw-v-2" class="dw-li dw-v" data-val="' + 63 + '" style="height:' + hi + 'px;line-height:' + hi + 'px;"><div class="dw-i">' + warr[i][59] + '</div></div>';
			}
            for (j in warr[i]) {
                if (l % 20 == 0) {
			...
			if(i==1&&loop)
			{
				html += '<div id="dw-v-3" class="dw-li dw-v" data-val="' + 60 + '" style="height:' + hi + 'px;line-height:' + hi + 'px;"><div class="dw-i">' + warr[i][0] + '</div></div>';
				html += '<div id="dw-v-4" class="dw-li dw-v" data-val="' + 61 + '" style="height:' + hi + 'px;line-height:' + hi + 'px;"><div class="dw-i">' + warr[i][1] + '</div></div>';
			}
            html += '</div>';
            return html;
        }
